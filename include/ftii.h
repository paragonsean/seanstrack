...
#define LS_OFF_AT_EOS_BIT unsigned(0x80000000)
#define ZERO_SPEED_OUTPUT_ENABLE_BIT unsigned(0x40000000)
...
Variable Numbers
---------------- */
#define PC_DITHER_FREQ_VN    int(244)
#define PC_DITHER_AMPL_VN    int(245)
...
#define VC_DITHER_FREQ_VN    int(347)
#define VC_DITHER_AMPL_VN    int(348)
#define ZERO_SPEED_CHECK_VN  int(349)    //No longer used
#define NULL_DAC_OFFSET_VN   int(350)
#define NULL_DAC_2_OFFSET_VN int(246)
#define LVDT_DAC_OFFSET_VN   int(351)
#define LVDT_DAC_2_OFFSET_VN int(247)
...
#define ZERO_SPEED_OUTPUT_MASK_VN int(394)
...
#define LS7_VN                 int(396)
#define LS8_VN                 int(397)
...
#define LS7_MASK_VN            int(400)
#define LS8_MASK_VN            int(401)

#define VALVE_TYPES_1_VN       int(414)
#define VALVE_TYPES_2_VN       int(415)
#define PULSE_TIME_VN          int(416)
#define DEVENT_TIME_VN         int(417)
#define PULSE_WIRE_VN          int(395)

#define DEMODULATOR_PHASES_VN  int(430)
#define DIGITAL_POTS_VN        int(431)
#define VALVE_SETTING_AFTER_JOG_SHOT_VN int(505)
...
double   realval();
virtual bool set( int new_vn, unsigned new_value );
virtual bool set( int new_vn, double new_value );
...
bool     get( STRING_CLASS & filename );
bool     get_from( STRING_CLASS & filename );
bool     put( STRING_CLASS & filename );
bool     put_into( STRING_CLASS & filename );
...
bool     set( int new_vn, unsigned new_value );
void     rewind() { ci=NO_INDEX; }
bool     prev();
bool     next();
bool     remove();
bool     remove( int i );
bool     update( int new_vn, unsigned new_value );
bool     update( int new_vn, double   new_value );
bool     update( FTII_VAR & sorc );

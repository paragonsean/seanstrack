...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib ..\freelib\v5subs.lib /NODEFAULTLIB:LIBC.LIB ..\freelib\dundas.lib /MAP /nologo /subsystem:windows,5.01 /MANIFEST:EMBED /incremental:no /machine:I386 /out:"free/profile.exe"
...
free\profile.exe : free\profile.obj free\alarmexp.obj free\bitmapcl.obj \
    ...
    free\profile.res
    copy free\profile.exe c:\v814\exes

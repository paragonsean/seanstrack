...
*                             FILL_LISTBOX                             *
***********************************************************************/
void VIRTUAL_LISTBOX_CLASS::fill_listbox()
{
int i;
int lastline;
...
*                            SET_SCROLLBAR                             *
***********************************************************************/
void VIRTUAL_LISTBOX_CLASS::set_scrollbar()
{
SCROLLINFO si;
...
*                            SET_SCROLLBAR_POS                         *
***********************************************************************/
void VIRTUAL_LISTBOX_CLASS::set_scrollbar_pos()
{
SCROLLINFO    si;
...
*                          SCROLL_UP_ONE_LINE                          *
***********************************************************************/
void VIRTUAL_LISTBOX_CLASS::scroll_up_one_line()
{
...
*                          SCROLL_UP_ONE_PAGE                          *
***********************************************************************/
void VIRTUAL_LISTBOX_CLASS::scroll_up_one_page()
{
int i;
...
***********************************************************************/
void VIRTUAL_LISTBOX_CLASS::scroll_down_one_page()
{
int i;
...
*                              GOTO_START                              *
***********************************************************************/
void VIRTUAL_LISTBOX_CLASS::goto_start()
{
top_line = 0;
set_scrollbar();
fill_listbox();
...
*                              GOTO_END                                *
***********************************************************************/
void VIRTUAL_LISTBOX_CLASS::goto_end()
{
...
*                                DO_SELECT                             *
***********************************************************************/
void VIRTUAL_LISTBOX_CLASS::do_select()
{
if ( t.open_status() )
...
*                              SHUTDOWN                                *
***********************************************************************/
void VIRTUAL_LISTBOX_CLASS::shutdown()
{
if ( t.open_status() )
    t.close();

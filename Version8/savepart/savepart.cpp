        ...
        if ( strings_are_equal(cp, DescList[i].desc) )
            ...
            switch( DescList[i].index )
                ...
                case SP_CHANNEL_01_SENSOR_INDEX:
                    CurrentPart.analog_sensor[0] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_02_SENSOR_INDEX:
                    CurrentPart.analog_sensor[1] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_03_SENSOR_INDEX:
                    CurrentPart.analog_sensor[2] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_04_SENSOR_INDEX:
                    CurrentPart.analog_sensor[3] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_05_SENSOR_INDEX:
                    CurrentPart.analog_sensor[4] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_06_SENSOR_INDEX:
                    CurrentPart.analog_sensor[5] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_07_SENSOR_INDEX:
                    CurrentPart.analog_sensor[6] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_08_SENSOR_INDEX:
                    CurrentPart.analog_sensor[7] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_09_SENSOR_INDEX:
                    CurrentPart.analog_sensor[8] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_10_SENSOR_INDEX:
                    CurrentPart.analog_sensor[9] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_11_SENSOR_INDEX:
                    CurrentPart.analog_sensor[10] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_12_SENSOR_INDEX:
                    CurrentPart.analog_sensor[11] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_13_SENSOR_INDEX:
                    CurrentPart.analog_sensor[12] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_14_SENSOR_INDEX:
                    CurrentPart.analog_sensor[13] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_15_SENSOR_INDEX:
                    CurrentPart.analog_sensor[14] = (short)sorc.int_value();
                    break;
                case SP_CHANNEL_16_SENSOR_INDEX:
                    CurrentPart.analog_sensor[15] = (short)sorc.int_value();
                    break;

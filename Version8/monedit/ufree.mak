...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib ..\ufreelib\v5subs.lib /nologo /MAP /subsystem:windows,5.01 /incremental:no /machine:I386 /out:"ufree/monedit.exe"
...
ufree\monedit.exe : ufree\monedit.obj ufree\monitor.obj ufree\monedit.res
    ...
    copy ufree\monedit.exe c:\v814wide\exes

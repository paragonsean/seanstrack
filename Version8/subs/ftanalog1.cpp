...
if ( f.open_for_write(fn.text()) )
    ...
    for ( i=0; i<MAX_PARMS; i++ )
        ...
        /*
        ------------------------------------------------------
        The target end_value is the position to start looking.
        If this is actually zero I save it as "0.0" so I will
        know it is not an old record the next time I read it.
        ------------------------------------------------------ */

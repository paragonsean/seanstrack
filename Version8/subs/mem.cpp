...
/***********************************************************************
*                          WCHAR_TO_CHAR                               *
* Convert a wchar string to a char string. Sorc and dest can be the    *
* same. n is the number of characters to convert. A null will be added *
* at the end of the string. MAKE SURE sizeof(dest) is at least n+1     *
***********************************************************************/
...
/***********************************************************************
*                               CHAR_TO_TCHAR                          *
*  This will allocat a dest buffer. You are responsible for deleting   *

...
*                          COMPARE_FILE_TIMES                          *
*                                                                      *
* This assumes that the file times are last write times. These are     *
* accurate to +- 2 seconds.                                            *
*                                                                      *
* No changes are made to the file times.                               *
*                                                                      *
* The FILETIME is the number of 100ns intervals since Jan 1, 1601.     *
* Two seconds is 2 billion ns or 20,000,000 intervals.                 *
*                                                                      *
*     -1 t1 < t2                                                       *
*      0 t1 and t2 vary by less than 2 seconds.                        *
*      1 t1 > t2                                                       *
*                                                                      *
***********************************************************************/
int compare_file_times( FILETIME & t1, FILETIME & t2 )
{
const DWORD TWO_SECONDS = 20000000;
DWORD d;
...
if ( t1.dwLowDateTime < t2.dwLowDateTime )
    {
    d = t2.dwLowDateTime - t1.dwLowDateTime;
    if ( d > TWO_SECONDS )
        return -1;
    return 0;
    }

d = t1.dwLowDateTime - t2.dwLowDateTime;
if ( d > TWO_SECONDS )
    return 1;

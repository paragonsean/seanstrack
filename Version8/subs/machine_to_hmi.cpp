...
if ( i > 0 )
    {
    i--;
    StringTable.find( ls.desc(i), TEXT("PRE_FAST") );
    x = 3;
...
if ( i > 0 )
    {
    i--;
    StringTable.find( ls.desc(i), TEXT("FAST") );
...
if ( i > 0 )
    {
    i--;
    StringTable.find( ls.desc(i), TEXT("SHOT_FULL_FORWARD") );
...
if ( i > 0 )
    {
    i--;
    StringTable.find( ls.desc(i), TEXT("INTENSIFICATION") );

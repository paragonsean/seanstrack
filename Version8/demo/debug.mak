CPP_PROJ=/nologo /MTd /W3 /Zp1 /Z7 /D "WIN32" /D "_WINDOWS" /D "_DEBUG" /Fp"..\include\debug.pch" /YX"windows.h" /Fo"debug/" /c
...
debug\demo.exe : debug\demo.obj debug\monitor.obj debug\demo.res
    link $(LINK32_FLAGS) debug\demo.obj debug\monitor.obj ..\empty\debug\empty.obj debug\demo.res
    copy debug\demo.exe \v7\exes

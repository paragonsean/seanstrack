...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib ..\ufreelib\v5subs.lib /nologo /subsystem:windows,5.01 /incremental:no /MANIFEST:EMBED /machine:I386 /out:"ufree/eventman.exe"

RSC_PROJ=/l 0x409 /fo"ufree\eventman.res" /d "NDEBUG"

eventman.exe : ufree\eventman.obj ufree\mail.obj ufree\eventman.res
    link $(LINK32_FLAGS) ufree\eventman.obj ufree\mail.obj ..\empty\ufree\empty.obj ufree\eventman.res
    copy ufree\eventman.exe c:\v814wide\exes

...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib mpr.lib htmlhelp.lib ..\ufreelib\v5subs.lib /nologo /subsystem:windows,5.01 /incremental:no /MANIFEST:EMBED /machine:I386 /out:"ufree/shiftrpt.exe"
...
ufree\shiftrpt.exe : ufree\shiftrpt.obj ufree\shiftrpt.res
    ...
    copy ufree\shiftrpt.exe c:\v814wide\exes

...
resource_string( shot_name_header, SHOT_NUMBER_STRING );
resource_string( date_name_header, DATE_NAME_STRING );
resource_string( time_name_header, TIME_NAME_STRING );
...
--------- */
ms.next();
resource_string( ms, UNITS_TITLE_STRING );
ms += Delimiter;
ms += Delimiter;
ms += Delimiter;
...
StringTable.find( s, TEXT("EXPORT_SHOT_PARAMS") );
s.set_text( hWnd );

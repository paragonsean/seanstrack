...
class STRINGTABLE_CLASS
    ...
    bool    append( STRING_CLASS & dest, TCHAR * id_to_find );
    bool    append( STRING_CLASS & dest, STRING_CLASS & id_to_find );
    HFONT   font() { return font_handle; }
    const   FONT_CLASS & fontclass() { return lf; }
    bool    find( STRING_CLASS & dest, TCHAR * id_to_find, bool appending );

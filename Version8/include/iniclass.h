...
class INI_CLASS
    ...
    bool get_bool();
    bool get_bool( const TCHAR * key );
    bool get_bool( const TCHAR * section, const TCHAR * key );
    ...
    bool put_bool( const TCHAR * dest_file_name, const TCHAR * section, const TCHAR * key, bool sorc );
    bool put_bool( const TCHAR * section, const TCHAR * key, bool sorc );
    bool put_bool( const TCHAR * key, bool sorc );

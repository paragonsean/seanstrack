...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib ..\freelib\v5subs.lib /nologo /subsystem:windows,5.01 /incremental:no /MANIFEST:EMBED /machine:I386 /out:"free/visiedit.exe"
...
free\visiedit.exe : free\visiedit.obj free\visiedit.res
    ...
    copy free\visiedit.exe \v814\exes

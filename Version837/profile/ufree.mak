CPP_PROJ=/nologo /MT /W3 /O1 /Zp1 /D "WIN32" /D "_WINDOWS" /D "NDEBUG" /D "UNICODE" /D "_UNICODE" /Fp"../include/ufree.pch" /Yu"windows.h" /Fo"ufree/" /c /EHsc

LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib wsock32.lib uuid.lib ..\ufreelib\v5subs.lib /NODEFAULTLIB:LIBC.LIB ..\ufreelib\dundas.lib /nologo /subsystem:windows,5.01 /incremental:no /MANIFEST:EMBED /machine:I386 /out:"ufree/profile.exe"
...
ufree\profile.exe : ufree\profile.obj ufree\alarmexp.obj ufree\bitmapcl.obj \
    ...
    ufree\plot.obj ufree\rtmlist.obj ufree\savepro.obj \
    ufree\status.obj ufree\tcconfig.obj \
    ufree\trend.obj ufree\viewpara.obj ufree\vlbclass.obj ufree\xaxis.obj ufree\xdcrplot.obj ..\empty\ufree\empty.obj \
    ufree\profile.res
    copy ufree\profile.exe c:\v8wide\exes

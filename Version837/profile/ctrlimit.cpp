...
*                                 READ                                 *
***********************************************************************/
BOOLEAN CONTROL_LIMIT_CLASS::read( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part )
{
NAME_CLASS s;
s.get_ctrlimit_dbname( computer, machine, part );
return read( s.text() );
}
...
*                                 READ                                 *
***********************************************************************/
BOOLEAN CONTROL_LIMIT_CLASS::read( PART_NAME_ENTRY & p )
{
return read( p.computer, p.machine, p.part );
}
...
*                                WRITE                                 *
***********************************************************************/
BOOLEAN CONTROL_LIMIT_CLASS::write( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part )
{
NAME_CLASS s;
s.get_ctrlimit_dbname( computer, machine, part );
return write( s.text() );
...
*                                WRITE                                 *
***********************************************************************/
BOOLEAN CONTROL_LIMIT_CLASS::write( PART_NAME_ENTRY & p )
{
return write( p.computer, p.machine, p.part );
}

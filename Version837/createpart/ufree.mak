...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib wsock32.lib uuid.lib ..\ufreelib\v5subs.lib /nologo /MAP /subsystem:windows,5.01 /incremental:no /MANIFEST:EMBED /machine:I386 /out:"ufree/createpart.exe"
...
ufree\createpart.exe : ufree\createpart.obj ufree\touni.obj ufree\createpart.res
    ...
    copy ufree\createpart.exe c:\v8wide\exes

...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib ole32.lib wsock32.lib uuid.lib ..\ufreelib\v5subs.lib /nologo /subsystem:windows,5.01 /incremental:no /MANIFEST:EMBED /machine:I386 /out:"ufree/copyv5.exe"
...
ufree\copyv5.exe : ufree\copyv5.obj ufree\copyv5.res
    ...
    copy ufree\copyv5.exe c:\v8wide\exes

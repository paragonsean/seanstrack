CPP_PROJ=/nologo /MTd /W3 /Zp1 /Z7 /D "WIN32" /D "_WINDOWS" /D "NDEBUG" /Fp"..\include\debug.pch" /Yu"windows.h" /Fo"debug/" /c /EHsc
...
debug\setup.exe : debug\setup.obj debug\menupdat.obj debug\setup.res
    link $(LINK32_FLAGS) debug\setup.obj debug\menupdat.obj ..\empty\debug\empty.obj debug\setup.res

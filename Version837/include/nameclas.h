...
inline BOOLEAN get_computer_csvname() { return get_data_dir_file_name(COMPUTER_CSV); }
inline BOOLEAN get_computer_csvname( STRING_CLASS & computer) { return get_data_dir_file_name(computer, COMPUTER_CSV); }
...
inline BOOLEAN get_ftcalc_csvname( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part ) { return get_part_dir_file_name( computer, machine, part, FTCALC_CSV ); }
       BOOLEAN get_ftcalc_param_file_name( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part, const TCHAR * parameter_name );
...
inline BOOLEAN get_ftchan_csvname( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part ) { return get_part_dir_file_name( computer, machine, part, FTCHAN_CSV ); }
...
inline BOOLEAN get_network_csvname() { return get_data_dir_file_name( NETWORK_CSV_FILE ); }
...
inline BOOLEAN get_save_csv_w_shot_setup_file_name( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part ) { return get_part_dir_file_name( computer, machine, part, SAVE_CSV_W_SHOT_CSV ); }

...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib wsock32.lib uuid.lib ..\freelib\v5subs.lib ..\freelib\dundas.lib /nologo /subsystem:windows,5.01 /incremental:no /MANIFEST:EMBED /machine:I386 /out:"free/emachine.exe"
...
free\emachine.exe : free\editdiff.obj free\emachine.obj free\emachine.res
    ...
    copy free\emachine.exe c:\v8\exes

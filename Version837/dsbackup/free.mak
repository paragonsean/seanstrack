...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib ole32.lib wsock32.lib uuid.lib htmlhelp.lib ..\freelib\v5subs.lib /nologo /subsystem:windows,5.01 /incremental:no /MANIFEST:EMBED /machine:I386 /out:"free/dsbackup.exe"
...
free\dsbackup.exe : free\global_file_settings.obj free\dsbackup.obj free\backupcl.obj free\dsbackup.res
    ...
    copy free\dsbackup.exe c:\v8ds\exes

...
LINK32_FLAGS= libcmtd.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib ole32.lib uuid.lib mpr.lib htmlhelp.lib wsock32.lib ..\debuglib\v5subs.lib /nologo /subsystem:windows /incremental:no /MANIFEST:EMBED /pdb:"debug\netsetup.pdb" /NODEFAULTLIB:libcmt.lib /debug /machine:I386 /out:"debug/netsetup.exe"

RSC_PROJ=/l 0x409 /fo"debug\netsetup.res"

debug\netsetup.exe : debug\netsetup.obj debug\netsetup.res
    link $(LINK32_FLAGS) debug\netsetup.obj ..\empty\debug\empty.obj debug\netsetup.res

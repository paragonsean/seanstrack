...
LINK32_FLAGS= libcmtd.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib wsock32.lib  mpr.lib ..\debuglib\v5subs.lib /nologo /subsystem:windows /incremental:no /pdb:"debug\serialtest.pdb" /NODEFAULTLIB:libcmt.lib /debug /machine:I386 /out:"debug/serialtest.exe"

RSC_PROJ=/l 0x409 /fo"debug\serialtest.res"

debug\serialtest.exe : debug\serialtest.obj debug\serialtest.res
    link $(LINK32_FLAGS) debug\serialtest.obj ..\empty\debug\empty.obj debug\serialtest.res

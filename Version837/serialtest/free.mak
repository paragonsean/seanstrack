...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib wsock32.lib mpr.lib ..\freelib\v5subs.lib /nologo /subsystem:windows,5.01 /incremental:no /machine:I386 /out:"free/serialtest.exe"

RSC_PROJ=/l 0x409 /fo"free\serialtest.res" /d "NDEBUG"

free\serialtest.exe : free\serialtest.obj free\serialtest.res
    link $(LINK32_FLAGS) free\serialtest.obj ..\empty\free\empty.obj free\serialtest.res

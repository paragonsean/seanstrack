...
double * calculate_ftii_parameters(FTII_PROFILE & f, MACHINE_CLASS & machine, PART_CLASS & part, PARAMETER_CLASS & param, ANALOG_SENSOR & asensor, FTANALOG_CLASS & ftanalog, FTCALC_CLASS & ftclass, LIMIT_SWITCH_CLASS &limts );
...
if ( get_shotsave_semaphore(DestPart.computer, DestPart.machine) )
    ...
    if ( nextshot() )
        ...
        ftcalc.load( SorcParam, DestPart.computer, DestPart.machine, DestPart.part);

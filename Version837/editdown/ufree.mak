...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib wsock32.lib uuid.lib ..\ufreelib\v5subs.lib /nologo /subsystem:windows,5.01 /incremental:no /MANIFEST:EMBED /machine:I386 /out:"ufree/editdown.exe"
...
ufree\editdown.exe : ufree\editdown.obj ufree\category.obj ufree\editdown.res
    link $(LINK32_FLAGS) ufree\editdown.obj ufree\category.obj ..\empty\ufree\empty.obj ufree\editdown.res
    copy ufree\editdown.exe c:\v8wide\exes

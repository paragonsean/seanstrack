...
***********************************************************************/
void new_downtime_callback( SOCKET_MSG * msg )
{
    DOWN_DATA_CLASS dd;
...
***********************************************************************/
void new_monitor_setup_callback( SOCKET_MSG * msg )
{
    MACHINE_CLASS m;  
    STRING_CLASS  s;
    HWND          w;
...
***********************************************************************/
void ft2_shutdown_callback( SOCKET_MSG *msg )
{
...
*                              PLOT_MIN_CALLBACK                       *
***********************************************************************/
void plot_min_callback( SOCKET_MSG *msg )
{
...
switch (msg)
    ...
    case WM_DBINIT:
        ...
        EventClient.register_for_event( MONITOR_SETUP_INDEX, new_monitor_setup_callback );
        EventClient.register_for_event( DOWN_DATA_INDEX, new_downtime_callback );
        ...
        EventClient.register_for_event( SHUTDOWN_INDEX, ft2_shutdown_callback );

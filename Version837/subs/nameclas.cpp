...
*                         GET_LOG_FILE_NAME                            *
***********************************************************************/
BOOLEAN NAME_CLASS::get_log_file_name()
{
    STRING_CLASS s;

    s = SERVICE_LOG_FILE_NAME_BASE;
    s += PeriodChar;
    s += SERVICE_LOG_FILE_NAME_EXT;

    return get_data_dir_file_name( s.text() );
}
...
*                         c:\v5\symphony\e20                           *
*                if machine is empty then c:\v5\symphony               *
***********************************************************************/
BOOLEAN NAME_CLASS::get_symphony_machine_directory( STRING_CLASS & computer, STRING_CLASS & machine )
{
...
/***********************************************************************
*                        GET_SYMPHONY_DIRECTORY                        *
*                            c:\v5\symphony                            *
***********************************************************************/
BOOLEAN NAME_CLASS::get_symphony_directory( STRING_CLASS & computer )
{
return get_symphony_machine_directory( computer, EmptyString );
}
...
/***********************************************************************
*                      GET_FTCALC_PARAM_FILE_NAME                      *
***********************************************************************/
BOOLEAN NAME_CLASS::get_ftcalc_param_file_name( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part, const TCHAR * parameter_name )
{
    NAME_CLASS n;
    ...
    return get_part_dir_file_name( computer, machine, part, n.text() );
}

/***********************************************************************
*                               SUBDIR_COUNT                           *
***********************************************************************/
int NAME_CLASS::subdir_count()
{
    static TCHAR AsterixString[] = TEXT( "*" );

    int             count;
    WIN32_FIND_DATA fd;
    HANDLE          hfind;
    STRING_CLASS    pattern;

    pattern = text();
    pattern.cat_path( AsterixString );
    ...
    ---------------------------- */
    count = 0;
    hfind = FindFirstFile( pattern.text(), &fd );

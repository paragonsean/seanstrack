...
*                               get_bool                            *
***********************************************************************/
bool INI_CLASS::get_bool( const TCHAR * section, const TCHAR * key )
{
if ( find(section, key) )
    return get_bool();
...
*                               get_bool                            *
***********************************************************************/
bool INI_CLASS::get_bool( const TCHAR * key )
{
if ( section_name )
    return get_bool( section_name, key );
...
*                               put_bool                               *
***********************************************************************/
bool INI_CLASS::put_bool( const TCHAR * section, const TCHAR * key, bool sorc )
{
...
return boolean_to_bool( put_string(section, key, checkedchar) );
}
...
*                              put_boolean                             *
***********************************************************************/
bool INI_CLASS::put_bool( const TCHAR * key, bool sorc )
{
if ( section_name )
    return put_bool( section_name, key, sorc );
...
*                               put_bool                               *
***********************************************************************/
bool INI_CLASS::put_bool( const TCHAR * dest_file_name, const TCHAR * section, const TCHAR * key, bool sorc )
{
set_file( dest_file_name );
return put_bool( section, key, sorc );
}

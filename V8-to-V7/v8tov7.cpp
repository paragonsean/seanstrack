...
ITEMIDLIST * startdir;
BOOL         havebuf;
static NAME_CLASS lastpath;

startdir = NULL;
if ( !lastpath.isempty() )
    {
    lastpath.remove_ending_filename();    //Part Name
    lastpath.remove_ending_filename();    //Machine Name
    startdir = ILCreateFromPath( lastpath.text() );
    }

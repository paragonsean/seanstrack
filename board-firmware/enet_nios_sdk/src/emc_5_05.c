...
//////////////////////// FIRMWARE VERSION ////////////////////////
#define FIRMWARE_VERSION "emc_5_05,"
...
void time_based_monitor_isr(int context)
	...
	WRITE_OSW1;	// Write OSW1 every mS, was finding outputs were changing
...
inline void monitor_supervisor(void)
	{
	int y, axis_num=1, shot_data_size, cs_present, ss_present, proceed, pos=0, input_300_sensed=0;
	static int cs_went_low;
	volatile unsigned short int *halfword_ptr;
	//vp_pvu *pv1 = va_pv1;
	np_pio *misc_ins_pio = na_misc_ins;
	...
	else if (!(MONITOR_ENABLE) && ((CS_DETECTED) || CS_PRESENT)) // CS_DETECTED is set from start shot or here after CS_PRESENT. CS_PRESENT is from input 300. 
//#if BUILD_FOR_CONTROL
...
//	#endif
		...
		if (CS_PRESENT) input_300_sensed=1; // Identify who caused a CS in the first place
		proceed=1;

...
#define CONFIG_WORD1 vtg.v[313]
	...
	#define TURN_OFF_TOGGLE_MODE (1<<31) // Diables analog channels alternating 4 and 4 above 200 IPS.
	

#define CONV_HI_CHANNELS (CONFIG_WORD1 & SEL_CH17_20_DYN)
#define ZSPEED_OUTPUT_ENABLED (CONFIG_WORD1 & ZSPEED_OUTPUT_ENBL)
#define TOGGLE_MODE_ENABLED !(CONFIG_WORD1 & TURN_OFF_TOGGLE_MODE)
...
#define ISW_BITS_TO_WATCH	vtg.v[427]
#define DELAY_BETWEEN_ANALOG_SAMPLES vtg.v[428]
#define ANALOG_MODE vtg.v[429] // Selects dynamic channel modes 1-5.

// vtg.v[428] - vtg.v[511] available
...
#define TOGGLE_ANALOG shared_memory[19]
...
#define SETUP17 0xb360	
#define SETUP18 0xb760	
#define SETUP19 0xbb60	
#define SETUP20 0xbf60
...
//#define FLOATING_CHANNEL_SETUP ad_setup[8]
...
#define SET_ZSPEED				vtg.gp_config_word |= 0x00000040; \
								TOGGLE_ANALOG=0; // Convert all 8 channels, no alternating
...
#define AXIS1_VALVE_TYPE 0 // No valve types defined yet
#define AXIS2_VALVE_TYPE 0
...
#define POS_BK_GN_FE     (axis[axis_num].control_parameters.pos_bk_gn1)

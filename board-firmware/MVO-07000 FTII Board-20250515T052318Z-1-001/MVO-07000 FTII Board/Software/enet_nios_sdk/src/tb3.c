...
// 8-28-03 tb3.c added support for analog channels 21-24 when using rev D version of External board.
...
int convert_ana_ch(int ch_num, int result_type, int *result)
	...
	unsigned int spi_data;
		...
		ch_num--; // Channels numbered 0 - 23, sent to this function as 1 - 24;

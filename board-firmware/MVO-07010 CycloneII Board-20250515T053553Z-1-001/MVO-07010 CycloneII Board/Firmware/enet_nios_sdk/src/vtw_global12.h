...
#define VEL_LOOP_INT_GAIN (axis[axis_num].control_parameters.vel_loop_int_gain)
...
#define SAMPLE_TIME			(axis[axis_num].control_parameters.sample_time) // Sample time converted to timer counts
...
#define VALCE_PID_RECURSIVE_INTEGRAL(x) (axis[x].pid.recursive_integral)

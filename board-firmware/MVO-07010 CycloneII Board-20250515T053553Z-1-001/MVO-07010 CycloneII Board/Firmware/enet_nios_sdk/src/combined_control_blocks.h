...
#define BLOCK_TIMEOUT_ERROR 102 // Available if we want to make timeout a fatal error in future.
#define INVALID_BLOCK 103
#define BLOCK_EXECUTION_ERROR 104
#define PROGRAM_STOPPED_BY_USER 105
#define MASTER_ENABLE_DROPPED_OUT 106
#define TEST_FATAL_ERROR 110
////////////////////////////////////////////////////////////////////
...
#define STOP_CONTROL	vtg.prog_ctr = 1; \
						vtg.stack_ptr = 0; \
						MASK_ALL_CONT_INTERRUPTS; \
...
#define ARM_TIMER2_FOR_GP_TIMING(timl, timh, cont) \
								timer2->np_timercontrol = 8; /* Stop timer */ \
								vtg.timer2_timeout = 0; /* We don't really use this */ \
								timer2->np_timerperiodl = timl; \
								timer2->np_timerperiodh = timh; \
								if (cont) timer2->np_timercontrol = 7; /* run continously */ \
								else timer2->np_timercontrol = 5

#define STOP_TIMER2 timer2->np_timercontrol = 8

...
2-25-04 emc_4_0 Made A/D setups in on-chip shared memory.
  ...
  6-1-07 emc_6_55 / emc_7_0.c
	...
	6-4-10 Special test version for Zitai.  Outputs some servo loop information in debug modes 1 and 2.
	Requires combined_control_blocks9_tmp.c.
	*/
...
//////////////////////// FIRMWARE VERSION ////////////////////////
#define FIRMWARE_VERSION "cyc_7_10,"  
...
#if BUILD_FOR_CONTROL
	#include "combined_control_blocks9.h" // Both polled and interrupt driven control are supported in the "combined" file.
#endif
...
#include "combined_control_blocks9_tmp.c" // Both polled and interrupt driven control are supported in the "combined" file.

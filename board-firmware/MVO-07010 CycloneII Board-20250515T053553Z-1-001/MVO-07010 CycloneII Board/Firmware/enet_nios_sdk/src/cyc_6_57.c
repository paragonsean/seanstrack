...
//////////////////////// FIRMWARE VERSION ////////////////////////
#define FIRMWARE_VERSION "emc_6_57,"  //"cyc_7_0,"
...
1, From the SOPC builder command shell
	...
	a, nios2-build -b 0x2010000 cyc_6_?.c<CR>
	b, nios2-srec2flash  cyc_6_?.srec -flash_address=0x80000 -ram_address=0x2010000 -copy_size=0x80000<CR>
	c, Upload the file over Ethernet using the terminal program (preferable) or nios2-run cyc_6_?.flash<CR>.  

...
2-25-04 emc_4_0 Made A/D setups in on-chip shared memory.
  ...
  6-1-07 emc_6_55 / emc_7_0.c
	...
	6-6-07 emc_7_0.c
		...
		Bascially V6.57 renamed to V7.0.
	...
	12-13-07 emc_7_0_reversed_io.c

		Reversed both Opto inputs and outputs for testing Zitai's I/O board
	*/
...
//////////////////////// FIRMWARE VERSION ////////////////////////
#define FIRMWARE_VERSION "cyc_7_0_reversed_io,"  
...
int initialize_axes(void)
	...
	else {printf("clearing hi res enable\n"); CLR_HI_RES_ENABLE_SIGNAL;}

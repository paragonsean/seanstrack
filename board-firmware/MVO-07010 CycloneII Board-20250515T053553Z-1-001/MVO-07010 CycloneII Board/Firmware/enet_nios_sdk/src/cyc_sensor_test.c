...
2-25-04 emc_4_0 Made A/D setups in on-chip shared memory.
  ...
  6-1-07 emc_6_55 / emc_7_0.c
	...
	12-15-09 cyc_sensor_test.c
	Version for making some tests with the new hires sensor.
	*/
...
//////////////////////// FIRMWARE VERSION ////////////////////////
#define FIRMWARE_VERSION "cyc_sensor_test,"  
...
6,	When targeting the CycloneII board with EPCS serial flash, the configuration flash file is built with the following command:
	sof2flash --input=cyc_chip_16010201.sof --epcs<CR>
	
	This will create a file called cyc_chip_16010201.flash.  This file must then be manually edited and the following

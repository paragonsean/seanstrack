...
//////////////////////// FIRMWARE VERSION ////////////////////////
#define FIRMWARE_VERSION "emc_6_56,"  //"emc_7_0,"
...
1, From the SOPC builder command shell
	...
	a, nios2-build -b 0x400000 emc_6_?.c<CR>
	b, nios2-srec2flash  emc_6_?.srec -flash_address=0x140000 -ram_address=0x400000 -copy_size=0x40000<CR>
	c, nios2-run emc_6_?.flash<CR>  To download the flash file.

	For the CycloneII based board:
	a, nios2-build -b 0x2004000 emc_6_?.c<CR>
	b, nios2-srec2flash  emc_6_?.srec -flash_address=0x80000 -ram_address=0x2004000 -copy_size=0x80000<CR>
	c, Upload the file over Ethernet using the terminal program (preferable) or nios2-run emc_6_?.flash<CR>.  
...
6,	When targeting the CycloneII board with EPCS serial flash, the configuration flash file is built with the following command:
	...
	The following line must be added to the bottom of the file:
	e)
...
// Execute a test here look for the differences in configuration ram
//printf("Comparing configuration flash\n");
//for(x=0; x<0x3696e; x+=2)
//	{
//	r_epcs_read_buffer ((unsigned long)x, 2, (void *)&tempu);
//	r_epcs_read_buffer ((unsigned long)(x+0x40000), 2, (void *)&tempu1);
//	if (tempu != tempu1)
//		{
//		printf("Location %d, tempu=0x%x, tempu1=0x%x\n", x, tempu, tempu1);
//		}
//	}
//printf("Completed comparing configuration flash!!!\n");

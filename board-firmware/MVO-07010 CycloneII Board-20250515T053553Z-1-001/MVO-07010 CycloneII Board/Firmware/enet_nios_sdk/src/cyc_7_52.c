...
2-25-04 emc_4_0 Made A/D setups in on-chip shared memory.
  ...
  6-1-07 emc_6_55 / emc_7_0.c
	...
	5-18-10 cyc_7_52.c
	Now including combined_control_blocks10.c and .h
	Fixed problem with pressure control block.  If follow through does not come in, the block can hang.  Now, switching to manual mode will
	end the block as it should. 	
	*/
...
//////////////////////// FIRMWARE VERSION ////////////////////////
#define FIRMWARE_VERSION "cyc_7_52,"  

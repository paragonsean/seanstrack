...
class ALARM_SUMMARY_CLASS
    ...
    void                 set_counts( double * parameter, PARAMETER_CLASS * p, bool check_external_parameters );
    void                 save( const SYSTEMTIME & date_to_save, int32 shift_to_save, BOOLEAN is_update, STRING_CLASS & fname );
    ...
    void                 set_part( STRING_CLASS & new_computer, STRING_CLASS & new_machine, STRING_CLASS & new_part );

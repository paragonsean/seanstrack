...
/*
-------------------------------------------------------------
cp now points to the null character at the end of the string
I know there is at least one non-null character in the string
Backup until I find a backslash or reach path.
------------------------------------------------------------- */
while ( cp > path )
    {
    cp--;

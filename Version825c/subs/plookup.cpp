...
{
return fn.get_plookup_csvname( computer, machine, part );
}
...
/***********************************************************************
*                         GET_LAST_SHOT_NAME_ONLY                      *
* Read the last shot name from the file. This DOES update the current  *
* class file name in s. It does NOT load the setpoints. DO NOT put()   *
* after doing this. This is just for reading the last shot name.       *
***********************************************************************/
BOOLEAN PLOOKUP_CLASS::get_last_shot_name_only( STRING_CLASS & dest, STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part )
{
if ( init(computer, machine, part) )
    return get_one_value( dest, fn, PLOOKUP_LAST_SHOT_NAME_INDEX );
...
*                              operator=                               *
***********************************************************************/
void PLOOKUP_CLASS::operator=( const PLOOKUP_CLASS & sorc )
{
fn = sorc.fn;
SETPOINT_CLASS::operator=( sorc );
}

...
multipart_runlist_settings.init();
...
multipart_runlist_settings.get( computer, name );
...
multipart_runlist_settings.put( computer, name );
...
multipart_runlist_settings          = sorc.multipart_runlist_settings;

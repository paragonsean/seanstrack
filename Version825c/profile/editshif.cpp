...
*                            READ_EDITBOXES                            *
***********************************************************************/
BOOLEAN EDIT_SHIFT_CLASS::read_editboxes()
{
int32 i;
...
*                            FILL_EDITBOXES                            *
***********************************************************************/
void EDIT_SHIFT_CLASS::fill_editboxes()
{
...
***********************************************************************/
BOOLEAN EDIT_SHIFT_CLASS::saveall()
{
...
/***********************************************************************
*                    SET_EDIT_SHIFTS_SETUP_STRINGS                     *
***********************************************************************/
static void set_edit_shifts_setup_strings( HWND hWnd )
{
STRING_CLASS s;
WINDOW_CLASS w;
int          i;
...
static RESOURCE_TEXT_ENTRY rsn[] = {
    { SUNDAY_RADIO,          TEXT("SUNDAY") },
    { MONDAY_RADIO,          TEXT("MONDAY") },
    { TUESDAY_RADIO,         TEXT("TUESDAY") },
    { WEDNESDAY_RADIO,       TEXT("WEDNESDAY") },
    { THURSDAY_RADIO,        TEXT("THURSDAY") },
    { FRIDAY_RADIO,          TEXT("FRIDAY") },
    { SATURDAY_RADIO,        TEXT("SATURDAY") },
    { SAVE_CHANGES_BUTTON,   TEXT("SAVE_CHANGES") },
    { NEW_SHIFT_BUTTON,      TEXT("NEW_STRING") },
    { REMOVE_SHIFT_BUTTON,   TEXT("REMOVE") },
    { ACTUAL_DAY_STATIC,     TEXT("ACTUAL_DAY") },
    { SHIFT_STATIC,          TEXT("SHIFT_STRING") },
    { START_OF_SHIFT_STATIC, TEXT("START_OF_SHIFT") },
    { DAY_STATIC,            TEXT("DAY") },
    { LB_SHIFT_STATIC,       TEXT("SHIFT_STRING") },
    { LB_ACTUAL_DAY_STATIC,  TEXT("ACTUAL_DAY") },
    { START_TIME_STATIC,     TEXT("START_TIME") },
    { COPY_THIS_DAY_BUTTON,  TEXT("MAKE_ALL_DAYS") }
    };
...
w = hWnd;
w.set_title( StringTable.find(TEXT("SHIFT_SETUP")) );
w.refresh();
}
...
switch (msg)
    ...
    case WM_INITDIALOG:
        DialogWindow = hWnd;
        set_edit_shifts_setup_strings( hWnd );

...
*                            FTANALOG_ENTRY                            *
***********************************************************************/
FTANALOG_ENTRY::FTANALOG_ENTRY()
{
channel      = NO_FT_CHANNEL;
ind_var_type = POSITION_VAR;
result_type  = SINGLE_POINT_RESULT_TYPE;
}
...
array[i].ind_value         = ZeroPointZero;

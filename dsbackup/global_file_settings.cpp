...
static NAME_CLASS Default_machine_zip_path;
static NAME_CLASS Default_part_zip_path;
...
MyList.rewind();
while ( MyList.next() )
    MachineListbox.add( MyList.current_entry->name.machine.text() );

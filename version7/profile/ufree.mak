...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib ..\ufreelib\v5subs.lib /NODEFAULTLIB:LIBC.LIB ..\ufreelib\dundas.lib /nologo /subsystem:windows,5.01 /incremental:no /machine:I386 /out:"ufree/profile.exe"
...
ufree\profile.exe : ufree\profile.obj ufree\alarmexp.obj ufree\bitmapcl.obj \
    ...
    ufree\profile.res
    copy ufree\profile.exe \v7wide\exes

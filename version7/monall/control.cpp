...
*                            SET_BOARD_ADDRESS                         *
***********************************************************************/
static BOOLEAN set_board_address()
{
...
for ( i=0; i<MAX_BOARDS; i++ )
    ...
    if ( B.find(i+1) )
        ...
        {
        set_text( ManualControlWindow, BOARD_ONE_ADDRESS_BOX+i, EmptyString );
        }
    }
}
...
***********************************************************************/
static void send_command_to_board()
{
...
*                          SEND_DATA_TO_BOARD                          *
***********************************************************************/
static void send_data_to_board()
{
BOARD_DATA x;
TCHAR s[11];
...
***********************************************************************/
static void read_data_from_board()
{

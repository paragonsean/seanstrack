...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib ..\freelib\v5subs.lib /nologo /subsystem:windows,5.01 /incremental:no /machine:I386 /out:"free/eventman.exe"
...
free\eventman.exe : free\eventman.obj free\mail.obj free\eventman.res
    ...
    copy free\eventman.exe \v7\exes

...
BOOLEAN get_profile_name( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part, int32 shot_number, const TCHAR * suffix );
...
inline BOOLEAN get_output_wire_labels_csvname() { return get_data_dir_file_name( OUTPUT_WIRE_LABELS_FILE ); }
...
inline BOOLEAN get_profile_name( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part, int32 shot_number ) { return get_profile_name( computer, machine, part, shot_number, PROFILE_NAME_SUFFIX ); }
...
inline BOOLEAN get_profile_ii_name( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part, int32 shot_number ) { return get_profile_name( computer, machine, part, shot_number, PROFILE_II_SUFFIX ); }

...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib ..\freelib\v5subs.lib /nologo /subsystem:windows /incremental:no /machine:I386 /out:"free/savepart.exe"

RSC_PROJ=/l 0x409 /fo"free\savepart.res" /d "NDEBUG"

free\savepart.exe : free\savepart.obj free\touni.obj free\savepart.res
    link $(LINK32_FLAGS) free\savepart.obj free\touni.obj free\savepart.res
    copy free\savepart.exe \v7\exes

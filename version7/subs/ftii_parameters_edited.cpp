...
//for ( i=f.np; i<f.n; i++ )  2010-07-16 I changed this to start at my calculated p3 point + 1
...
----------------------- */
//i = f.np - int( machine.impact_points[PRE_IMPACT_INDEX] ); I changed this to use my new p3 position +1

...
***********************************************************************/
BOOLEAN MULTIPART_RUNLIST_CLASS::get( STRING_CLASS & cn, STRING_CLASS & mn, STRING_CLASS & pn )
{
int i;
INI_CLASS ini;
NAME_CLASS   s;
...
s.get_part_dir_file_name( cn, mn, pn, CONFIG_INI_FILE );
ini.set_file( s.text() );
...
*                               put                                    *
***********************************************************************/
BOOLEAN MULTIPART_RUNLIST_CLASS::put( STRING_CLASS & cn, STRING_CLASS & mn, STRING_CLASS & pn )
{
int i;
INI_CLASS ini;
NAME_CLASS s;
...
*                            create_runlist                            *
***********************************************************************/
BOOLEAN MULTIPART_RUNLIST_CLASS::create_runlist( STRING_CLASS & cn, STRING_CLASS & mn, STRING_CLASS & pn )
{

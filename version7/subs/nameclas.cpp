...
return get_part_results_dir_file_name( computer, machine, part, shot_file );
}

/***********************************************************************
*                           GET_PROFILE_NAME                           *
***********************************************************************/
BOOLEAN NAME_CLASS::get_profile_name( STRING_CLASS & computer, STRING_CLASS & machine, STRING_CLASS & part, int32 shot_number, const TCHAR * suffix )
{
TCHAR shot_file[SHOT_LEN+5];
TCHAR * cp;

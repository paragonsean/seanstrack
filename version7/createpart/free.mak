...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib ..\freelib\v5subs.lib /nologo /subsystem:windows /incremental:no /machine:I386 /out:"free/createpart.exe"

RSC_PROJ=/l 0x409 /fo"free\createpart.res" /d "NDEBUG"

free\createpart.exe : free\createpart.obj free\createpart.res
    link $(LINK32_FLAGS) free\createpart.obj free\createpart.res
    copy free\createpart.exe \v7\exes

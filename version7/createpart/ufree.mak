...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib ..\ufreelib\v5subs.lib /nologo /MAP /subsystem:windows /incremental:no /machine:I386 /out:"ufree/createpart.exe"
...
ufree\createpart.exe : ufree\createpart.obj ufree\touni.obj ufree\createpart.res
    link $(LINK32_FLAGS) ufree\createpart.obj ufree\touni.obj ufree\createpart.res
    copy ufree\createpart.exe \v7wide\exes

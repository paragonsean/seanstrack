...
static INT LowImpactControlId[] = {
    LI_1_EDITBOX, LI_2_EDITBOX, LI_3_EDITBOX,
    LI_4_EDITBOX, LI_5_EDITBOX, LI_6_EDITBOX
    };
...
/***********************************************************************
*                   INIT_NO_LAST_STEP_END_POS_DIALOG                   *
***********************************************************************/
static void init_no_last_step_end_pos_dialog( HWND hWnd )
{
WINDOW_CLASS w;
STRING_CLASS s;

w = hWnd;
s = StringTable.find( TEXT("NO_LAST_STEP_END_POS_FOUND") );
s.set_text( hWnd );

s = StringTable.find( TEXT("MACHINE_HAS_BINARY_VALVE") );
s.set_text( hWnd, NFPV_1_TBOX );

s = StringTable.find( TEXT("MUST_SPECIFY_LAST_STEP_END_POS") );
s.set_text( hWnd, NFPV_2_TBOX );
}
...
switch (msg)
    {
    case WM_INITDIALOG:
        init_no_last_step_end_pos_dialog( hWnd );
        break;
...
/***********************************************************************
*                 INIT_NO_LAST_STEP_LOW_IMPACT_DIALOG                  *
***********************************************************************/
static void init_no_last_step_low_impact_dialog( HWND hWnd )
{
WINDOW_CLASS w;
STRING_CLASS s;

w = hWnd;
s = StringTable.find( TEXT("NO_LAST_STEP_LOW_IMPACT_FOUND") );
s.set_text( hWnd );

s = StringTable.find( TEXT("MACHINE_HAS_BINARY_VALVE") );
s.set_text( hWnd, NFPV_1_TBOX );

s = StringTable.find( TEXT("MUST_SPECIFY_LAST_STEP_LOW_IMPACT") );
s.set_text( hWnd, NFPV_2_TBOX );
}
...
switch (msg)
    {
    case WM_INITDIALOG:
        init_no_last_step_low_impact_dialog( hWnd );
        break;
...
static RESOURCE_TEXT_ENTRY rlist[] =
    ...
    { ZERO_SPEED_OUTPUT_ENABLE_XB, TEXT("ENABLE") }
    };
        ...
        if ( cmd == BN_CLICKED )
            ...
            switch ( id )
                ...
                case ZERO_SPEED_OUTPUT_WIRE_PB:
                    choose_wire( w, hWnd, ZERO_SPEED_OUTPUT_TYPE, NO_INDEX );
                    CurrentPart.set_zero_speed_output_wire( short(get_int_from_ebox(w)) );
                    return TRUE;
                }
            }
        break;

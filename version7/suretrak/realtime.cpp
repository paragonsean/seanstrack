...
***********************************************************************/
static void do_read_control_parameters_request()
{
...
mypart = Runlist.find_part( SureTrakInputWord );

if ( !mypart.isempty() && (SureTrakPart.part != mypart) )
    {
    if ( part_exists( SureTrakPart.computer, SureTrakPart.machine, mypart) )
        MainWindow.post( WM_POKEMON, (WPARAM) 0, (LPARAM) mypart.release() );
    else
        MessageBox( 0, resource_string(NO_WARMUP_PART_STRING), mypart.text(), MB_OK | MB_SYSTEMMODAL );
    }
}
...
***********************************************************************/
BOOLEAN do_profile_download_request()
{
int status;
...
***********************************************************************/
BOOLEAN do_program_download_request()
{
...
s.get_control_program_file_name( SureTrakPart.computer );
...
***********************************************************************/
void do_null_valve_init_request()
{
...
***********************************************************************/
static void do_auto_null_request()
{
...
***********************************************************************/
static void do_valve_test_request()
{
int32 count;
BOARD_DATA x;
...
***********************************************************************/
static void send_vt_data_to_plot()
{
int32 i;
float pos;
BOARD_DATA x;
...
***********************************************************************/
static void check_for_valve_test()
{
if ( !TestingValve )
    return;
...
*                         UPDATE_SURETRAK_POS                          *
***********************************************************************/
static BOOLEAN update_suretrak_pos()
{
BOARD_DATA x;
...
***********************************************************************/
static void check_for_null_valve_display()
{
...
***********************************************************************/
static void check_for_analog_display()
{

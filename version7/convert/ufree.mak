...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib mpr.lib ..\ufreelib\v5subs.lib /nologo /subsystem:windows /incremental:no /machine:I386 /out:"ufree/convert.exe"

RSC_PROJ=/l 0x409 /fo"ufree\convert.res" /d "NDEBUG"

ufree\convert.exe : ufree\convert.obj ufree\convert.res
    link $(LINK32_FLAGS) ufree\convert.obj ufree\convert.res
    copy ufree\convert.exe \v7wide\exes
